...
export const classrooms = pgTable("classrooms", {
  ...
  classCode: varchar("class_code").unique().notNull(),
...
export const vocabularyCards = pgTable("vocabulary_cards", {
  ...
  clozeSentence: text("cloze_sentence"),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const studySettings = pgTable("study_settings", {
  ...
  level0Interval: integer("level0_interval").default(0),
  level1Interval: integer("level1_interval").default(1),
  level2Interval: integer("level2_interval").default(3),
  level3Interval: integer("level3_interval").default(7),
  level4Interval: integer("level4_interval").default(30),
...
export const sharedDeckAccess = pgTable("shared_deck_access", {
  ...
  deckId: integer("deck_id").references(() => sharedDecks.id).notNull(),
  userId: varchar("user_id").references(() => users.id).notNull(),
  accessLevel: varchar("access_level").default("view"),
